const CACHE='kelimelik-asistani-v7';
const CORE=['./','./index.html','./styles.css','./engine.js','./dictionary.js','./solver-worker.js','./dynamic-star.js','./app.js','./screenshot-v2.js','./result-enhancements.js','./manifest.webmanifest'];
